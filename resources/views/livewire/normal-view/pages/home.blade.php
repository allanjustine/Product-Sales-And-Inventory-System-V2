<div>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption text-center top-0">
                    ...
                    @if (auth()->check())
                    <a href="#" class="btn" id="view-btn" data-toggle="tooltip" data-placement="bottom" title="Have a nice day, {{ auth()->user()->name }}">
                        @if ($morning)
    ...
    <h4 class="text-center mt-4"><span class="location-text pb-2"><i class="fa-solid fa-location-dot fa-shake fa-xl" style="color: #ad0000;"></i> AJM Restaurant is
    ...
    <div class="container d-flex justify-content-center mt-5 mb-3">
        <iframe class="elevation-3 rounded" src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d413.07098686836446!2d123.970567480301!3d9.949291019306209!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zOcKwNTYnNTcuMCJOIDEyM8KwNTgnMTMuOCJF!5e0!3m2!1sen!2sph!4v1681485598511!5m2!1sen!2sph" width="700" height="350" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
    </div>
