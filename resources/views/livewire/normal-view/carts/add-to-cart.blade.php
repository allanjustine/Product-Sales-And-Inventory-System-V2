            ...
            <div class="modal-content">
                                ...
                                @if ($productToBeCart)
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p><strong>&#8369;{{ number_format($productToBeCart->product_price, 2, '.', ',') }}</strong>
                                            @if($productToBeCart->product_old_price !== null && $productToBeCart->product_old_price !== $productToBeCart->product_price)
                ...
                @if ($productToBeCart)
                    <div class="modal-footer">
                        <button type="button" wire:loading.attr="disabled" wire:target='addToCartNow' class="btn btn-primary form-control"
                            wire:click="addToCartNow">
                            <span wire:target='addToCartNow' wire:loading.remove>
