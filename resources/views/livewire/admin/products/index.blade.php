<div>
    ...
    <div class="table-responsive card card-primary card-outline card-outline-tabs" id="product-table" style="height: 500px;">
        <div class="card-body">
            <div class="col-sm-12">
                <label>Show:</label>
                ...
                <select name="product_category" id="product_category" class="form-select mb-3 float-end" style="width: 180px;" wire:model.live="category_name">
                ...
                <tbody>
                    ...
                    <tr key={{ $product->id }}>
                        ...
                        <td>
                            ...
                            <img src="{{ Storage::url($product->product_image) }}" style="height: 50px; width: 60px; border-radius: 5px;" alt="{{ $product->product_name }}">
                            @else
                            <img src="{{ url($product->product_image) }}" style="height: 50px; width: 60px; border-radius: 5px;" alt="{{ $product->product_name }}">
                            @endif
                        </td>
                        ...
                        @else
                        <td>{{ $product->product_rating }} <i class="fa-solid fa-star" style="color: #ffd700;"></i></td>
                        @endif
                        ...
                        <td class="text-center">
                            ...
                            <div class="custom-control custom-switch">
                                <input wire:click="statusChange({{ $product->id }})" type="checkbox" class="custom-control-input" id="customSwitch1{{ $product->id }}" checked>
                                <label class="custom-control-label" style="cursor: pointer;" for="customSwitch1{{ $product->id }}"></label>
                            </div>
                            @else
                            <div class="custom-control custom-switch">
                                <input wire:click="statusChange({{ $product->id }})" type="checkbox" class="custom-control-input" id="customSwitch1{{ $product->id }}">
                                <label class="custom-control-label" style="cursor: pointer;" for="customSwitch1{{ $product->id }}"></label>
                            </div>
                            @endif
    ...
    <div class="d-flex align-items-center">
        <span class="me-auto p-1 rounded">Showing: <span class="p-1 rounded" style="border: 1px solid rgba(156, 154, 154, 0.356); background-color:rgba(150, 209, 248, 0.384);"><strong>{{ $products->firstItem() }}-{{ $products->lastItem() }}</strong>
                of
