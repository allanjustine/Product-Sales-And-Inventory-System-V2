            ...
            <div class="modal-content">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="product_name"
                                        placeholder="Product Name" wire:model.live.debounce.200ms="product_name" required>
                                    @error('product_name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select" id="product_status" wire:model.live.debounce.200ms="product_status"
                                        required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" id="product_stock" placeholder="Product Stock"
                                        name="product Stock" wire:model.live.debounce.200ms="product_stock" class="form-control"
                                        required>
                                    @error('product_stock')
                                        <span class="text-danger">*{{ $message }}</span>
                                    @enderror
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" wire:click="update()">
                        <div wire:loading><svg class="loading"></svg></div>&nbsp;<i class="fa-solid fa-pen-to-square"></i> Update Product
                    </button>
