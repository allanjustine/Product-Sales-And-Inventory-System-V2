        ...
        <div class="card-body">
            <div class="col-sm-12">
                ...
                <input type="search" class="form-control mb-3 mx-2 float-end" style="width: 198px;"
                    placeholder="Search" wire:model.live.debounse.200ms="search">
                                ...
                                <td>
                                    @if ($order->order_status === 'Pending')
                                        <button type="button"
                                            ...
                                            style="width: 140px;">
                                            <i class="fa-sharp fa-solid fa-cart-circle-arrow-up"></i> <span>Process
                                                Order</span>
                                        </button>
                                    @elseif ($order->order_status === 'Processing Order')
                                        <button type="button"
            ...
            if (statusTitle[status]) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Livewire.dispatch(statusTitle[status], {
                            id
                        });
                    }
                });
